    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                {{ Form::open(array('route'=>['edit-class-put', $arrDetail->class_id], 'method'=>'PUT', 'class'=>'form-horizontal', 'autocomplete' => 'off')) }}
                    <div class="form-group">
                        <label for="" class="col-md-2 col-sm-2 control-label">Name
                            <span class="ta-requied">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6">
                                {{Form::text('class_name', $arrDetail->class_name, ['class'=> 'form-control', 'required','id'=>'class_name', 'maxlength' => '50'])}}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            {{ Form::select('course_id', array('' => 'Please select') + $arrCourse, $arrDetail->course_id, ['class' => "form-control", "required",'id'=>'course_id']); }}
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-3">
                            <div class='input-group date' id='datetimepicker1'>
                                {{Form::text('date', $arrDetail->date, ['class'=> 'form-control', 'required','id'=>'date'])}}
                        ...
                        <div class="input-group col-md-2 col-sm-2">
                            ...
                            {{Form::text('duration', $arrDetail->duration, ['class'=> 'form-control','id'=>'duration'])}}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            {{ Form::select('trainer_id', array('' => 'Please select') + $arrTrainer, $arrDetail->trainer_id, ['class' => "form-control"]); }}
                        </div>
                        <div class="col-md-2 col-sm-2">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-1 col-sm-1">
                                {{ Form::checkbox('has_examination', 1, ($arrDetail->has_examination == '1'), ['class' => 'checkbox ta-checkbox','id'=>'has_examination']) }}
                        </div>
                    </div>
            </div>
...
<script type="text/javascript">
    $(function () {
        ...
        if(localStorage.getItem("has_examination") === '1'){
            ...
            $('#has_examination').prop('checked', false);
        }
        localStorage.clear();
