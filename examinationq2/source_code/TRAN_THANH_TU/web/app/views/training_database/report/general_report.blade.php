...
@section('title','Monthly General Infomation Report')
@section('breadcrumb')
<li><a href="{{ URL::route('home'); }}">Home</a></li>
<li><a href="{{ URL::route('report'); }}">Report</a></li>
<li>Monthly General Infomation Report</li>
@stop
@section('content')
    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                {{ Form::open(['route' => 'general-report-post','class'=>'form-horizontal', 'autocomplete' => 'off']) }}
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                {{ Form::open(['route'=>'general-report-export','class'=>'form-horizontal']) }}
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-ajax">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$report->total_class}}</td>
                                        <td>{{$report->total_hours}}</td>
                                        <td>{{$report->total_participant}}</td>
                                        <td>{{$report->total_trainer}}</td>
                                        <td>{{$report->pass_rating}}</td>
                                        <td>{{$report->average_training_hours}}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
